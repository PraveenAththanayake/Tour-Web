    ...
    return (
      <div className="mx-auto my-20 flexCenter">
        <div className="relative w-[93vw]">
          <div className="z-0 h-[60vw] md:h-[50vw] xl:h-[40vw] overflow-hidden rounded-lg relative">
            <Slider {...settings}>
              <div className="relative">
                ...
                <div className="absolute w-[90%] top-1/2 md:top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white flexCenter flex-col text-center">
                  <h1 className="text-lg sm:text-3xl lg:text-5xl font-medium">
                    Discover the Untouched Beauty of Sri Lanka
                  </h1>
                  <p className="italic mt-3 md:mt-8 text-[10px] sm:text-base lg:text-xl">
                  ...
                  <CustomButton
                    title="Explore Now"
                    containerStyles="bg-green-500 text-xs sm:text-base py-2 px-6 sm:py-3 mt-5 rounded-md max-sm:hidden"
